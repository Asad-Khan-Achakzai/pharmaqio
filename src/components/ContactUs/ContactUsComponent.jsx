        ...
        script.addEventListener('load', () => {
            if(window.hbspt) {
              window.hbspt.forms.create({
                portalId: "4404057",
                formId: "43afbabe-3886-4941-bec9-09f6250df04b",
                ...
                <div className="container">
                  <Row>
                    <Col md={6}>
                        ...
                        <div id='footer-content-sec-1' className="footer-content-section">
                            <div className='initial-opacity-transform-block'>
                                <div className="col-heading">
                                    <div>
                                        <p className="m-0">Explore X-96</p>
                                    </div>
                                    <div className="w-75">
                                        <div class="separator">
                                        <span></span>
                                ...
                                <div className="footer-col-list">
                                    <ul>
                                        <li>
                                            <Link className='text-white' to='/' onClick={(e) => window.scrollTo(0, 0)}>Home</Link>
                                        </li>
                                        <li>
                                            <Link className='text-white' to='/services' onClick={(e) => window.scrollTo(0, 0)}>Services</Link>
                                        </li>
                                        <li>
                                            <HashLink className='text-white' to='/#our-portfolio' elementId="homepage-section-4-main-wrapper">Portfolio</HashLink>
                                        </li>
                                        <li>
                                            <HashLink className='text-white' to='/#testimonials' elementId="home-testimonial-section">Testimonials</HashLink>
                                        </li>
                                        <li>
                                            <a className='text-white' href='https://www.xgrid.co/careers/' target='_blank' rel="noopener noreferrer">Careers at Xgrid
                                        ...
                                        <li>
                                            <a className='text-white' href='https://www.xgrid.co/blog/' target='_blank' rel="noopener noreferrer">Blog
                                            <svg class="mx-2 mb-1" width="16" height="16" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M20.4492 1.45312C19.2305 0.246094 17.5664 0 15.4219 0H6.42188C4.30078 0 2.63672 0.246094 1.42969 1.45312C0.222656 2.64844 0 4.30078 0 6.42188V15.3516C0 17.5078 0.222656 19.1602 1.42969 20.3555C2.63672 21.5625 4.30078 21.7969 6.44531 21.7969H15.4219C17.5664 21.7969 19.2422 21.5625 20.4492 20.3555C21.6445 19.1484 21.8672 17.5078 21.8672 15.3516V6.45703C21.8672 4.30078 21.6445 2.64844 20.4492 1.45312ZM19.5352 6.12891V15.6797C19.5352 16.8984 19.3828 18 18.7383 18.6445C18.082 19.3008 16.9688 19.4648 15.75 19.4648H6.12891C4.91016 19.4648 3.78516 19.2891 3.14062 18.6445C2.49609 18 2.33203 16.8984 2.33203 15.6797V6.15234C2.33203 4.91016 2.49609 3.79688 3.14062 3.15234C3.78516 2.50781 4.91016 2.34375 6.15234 2.34375H15.75C16.9688 2.34375 18.082 2.50781 18.7383 3.15234C19.3828 3.80859 19.5352 4.91016 19.5352 6.12891ZM14.6016 13.957C15.1875 13.957 15.5625 13.5234 15.5625 12.8906V7.44141C15.5625 6.62109 15.1055 6.25781 14.3672 6.25781H8.89453C8.25 6.25781 7.83984 6.63281 7.83984 7.21875C7.83984 7.81641 8.26172 8.19141 8.90625 8.19141H10.875L12.4688 8.00391L10.7461 9.58594L6.64453 13.6875C6.44531 13.8867 6.30469 14.1562 6.30469 14.4375C6.30469 15.0703 6.75 15.4805 7.34766 15.4805C7.66406 15.4805 7.92188 15.3633 8.14453 15.1523L12.2344 11.0625L13.793 9.36328L13.6289 11.0391V12.9023C13.6289 13.5469 14.0039 13.957 14.6016 13.957Z" fill="white"></path></svg>
                                            </a>
                                        </li>
                                    </ul>
                        ...
                        <div id='footer-content-sec-2' className="footer-content-section">
                            <div className='initial-opacity-transform-block'>
                                <div className="col-heading">
                                    <div>
                                ...
                                <div className="company-address">
                                    <p className="text-white w-50">
                                        Building 96, Street # GCC-11,<br />
                                        Civic Centre, Gulberg Greens<br />
                                        Islamabad.
                                    </p>
                                </div>
                                </div>
                        ...
                        <div id='footer-content-sec-3' className="footer-content-section">
                            <div className='initial-opacity-transform-block'>
                                <div className="col-heading">
                                <div>
                                ...
                                <div className="py-3">
                                    <div className="w-35 d-flex justify-content-between mobile-styles-social-footer">
                                        <a href="https://www.facebook.com/Xninetysix/" target="_blank" rel="noopener noreferrer">
                                            <svg
                                                width="12"
                                                height="20"
                                                viewBox="0 0 12 20"
                                        ...
                                        <a href="https://twitter.com/x_ninety_six" target="_blank" rel="noopener noreferrer">
                                            <svg
                                                width="22"
                                                height="19"
                                                viewBox="0 0 22 19"
                                        ...
                                        <a href="https://www.linkedin.com/company/x-96/" target="_blank" rel="noopener noreferrer">
                                            <svg
                                                width="18"
                                                height="18"
                                                viewBox="0 0 18 18"
