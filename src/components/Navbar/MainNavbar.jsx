  ...
  return (
    <Fragment>
      <Navbar
        expand="lg"
        variant="dark"
        className="navbar-main-wrapper nav--default"
        expanded={expanded}
      >
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          ...
          <Link
              ...
              <Link
                activeClass="active"
                to="homepage-section-3-main-wrapper"
                spy={true}
                smooth={true}
                offset={-30}
                onClick={() => setExpanded(false)}
              ...
              <Link
                activeClass="active"
                to="homepage-section-4-square-main-wrapper"
                spy={true}
                smooth={true}
                offset={-30}
                onClick={() => setExpanded(false)}
              ...
              <Link
                activeClass="active"
                to="homepage-section-5-square-main-wrapper"
                spy={true}
                smooth={true}
                offset={-30}
                onClick={() => setExpanded(false)}
              ...
              <Link
                activeClass="active"
                to="homepage-section-6-square-main-wrapper"
                spy={true}
                smooth={true}
                offset={-30}
                onClick={() => setExpanded(false)}
          ...
          <Nav className="ml-auto nav-right d-block d-lg-flex align-items-center">
            ...
            <Button className="navbar-request-demo" variant="outline-light">
              Place order
            </Button>
          </Nav>
        </Navbar.Collapse>
      ...
      <Modal show={show}>
        ...
        >
          ...
          <rect
            ...
            height="2.35035"
            rx="1.17518"
            transform="matrix(-0.707107 0.707107 0.707107 0.707107 22.9084 11)"
            fill="#161822"
          />
        </svg>
        <h2 className="mb-3">
          Let’s make your brand <br /> the next sensation!
        </h2>
        <div className="px-5">
          <HubspotForm
            portalId="4404057"
