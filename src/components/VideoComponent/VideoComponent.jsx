...
const VideoComponent = (props) => {
    return (
        <Fragment>
            {
                props.heading ?
                    <div id='video-component-wrapper' className='video-component-main-wrapper position-relative'>
                        ...
                        <div className='video-section-inner-wrapper'>
                            {
                                props.videomp4 ?
                                    <video width="100%" autoPlay muted loop playsInline>
                                        {/* <source src="./assets/video/desktop-webm/stay_tuned.webm" type="video/webm"> */}
